...
public class ProductRepository {
    ...
    public void updateProduct(Product productSave) {
        list.forEach(product -> {
            if(product.getId().equals(productSave.getId())){
                ...
                product.setCreatedOne(productSave.getCreatedOne());
    ...
    public void addList(List<Product> listOfProducts) {
        listOfProducts.addAll(getAllProducts());
    }
}
